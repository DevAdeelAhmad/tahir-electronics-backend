...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    companyHistory: Schema.Attribute.Blocks;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiBrandBrand extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Electronics brands and manufacturers';
    displayName: 'Brand';
    pluralName: 'brands';
    singularName: 'brand';
  };
...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Contact page information and settings';
    displayName: 'Contact';
    pluralName: 'contacts';
  ...
  attributes: {
    ...
    contactFormSettings: Schema.Attribute.JSON &
      Schema.Attribute.DefaultTo<{
        placeholders: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    socials: Schema.Attribute.Component<'shared.contact-info', false>;
    subtitle: Schema.Attribute.String;
...
export interface ApiCustomerCustomer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    defaultBillingAddress: Schema.Attribute.Integer &
    ...
    defaultShippingAddress: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    >;
    userAccountId: Schema.Attribute.Integer;
...
export interface ApiHeroSliderHeroSlider extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Hero section slider with dynamic slides';
...
export interface ApiOrderItemOrderItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    discounts: Schema.Attribute.JSON;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiPrivacyPolicyPrivacyPolicy extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    informationWeCollect: Schema.Attribute.Blocks;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    yourRights: Schema.Attribute.Blocks;
  };
}
...
export interface ApiProductVariantProductVariant
  ...
  info: {
    description: 'Different options/sizes/prices for products';
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Create and manage products for your e-commerce store';
    displayName: 'Product';
    pluralName: 'products';
  ...
  attributes: {
    ...
    sku: Schema.Attribute.String &
      ...
      Schema.Attribute.Unique;
    slug: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    stockInfo: Schema.Attribute.Component<'shared.stock-info', false>;
    subCategories: Schema.Attribute.Relation<
      'manyToMany',
      'api::sub-category.sub-category'
    >;
...
export interface ApiShippingBadgeShippingBadge
  extends Struct.CollectionTypeSchema {
  collectionName: 'shipping_badges';
  info: {
    displayName: 'shippingBadge';
    pluralName: 'shipping-badges';
    singularName: 'shipping-badge';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiShippingMethodShippingMethod
  ...
  info: {
    description: 'Different shipping options available';
  ...
  attributes: {
    ...
    handlingFee: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    isActive: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiSpecialOfferSpecialOffer
  ...
  info: {
    description: 'Special offers and promotions section';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    offer1: Schema.Attribute.String & Schema.Attribute.Required;
    offer2: Schema.Attribute.String & Schema.Attribute.Required;
    offer3: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTermsOfServiceTermsOfService
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    ordersPaymentsShippings: Schema.Attribute.Blocks;
    publishedAt: Schema.Attribute.DateTime;
    returnsAndLegalTerms: Schema.Attribute.Blocks;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    useOfOurServices: Schema.Attribute.Blocks;
  };
}
...
export interface ApiWishlistWishlist extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'User product favorites and wishlists';
  ...
  attributes: {
    ...
    items: Schema.Attribute.Component<'wishlist.wishlist-item', true>;
    lastUpdated: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Default'>;
    ...
    publishedAt: Schema.Attribute.DateTime;
    sessionId: Schema.Attribute.String;
    shareableLink: Schema.Attribute.String & Schema.Attribute.Unique;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::shipping-badge.shipping-badge': ApiShippingBadgeShippingBadge;
